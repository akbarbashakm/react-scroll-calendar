...
var ScrollCalendar = function (_Component) {
  ...
  _createClass(ScrollCalendar, [{
    ...
    value: function componentDidMount() {
      ...
      var element = document.getElementById((0, _moment2.default)(this.props.selectedDate, 'DD/MMM/YYYY').format('MMMM'));
      if (element) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(RenderCalendarYear, props)
      );
    }
  }]);
...
var RenderMonthCard = exports.RenderMonthCard = function RenderMonthCard(props) {
  ...
  return _react2.default.createElement(
    'section',
    { 'class': 'month', id: now.format('MMMM') },
...
var RenderDays = exports.RenderDays = function RenderDays(_ref2) {
  ...
  var renderUnwantedDay = function renderUnwantedDay(balanceDayCount) {
    ...
    for (var i = 0; i < balanceDayCount; i++) {
      elements.push(_react2.default.createElement('li', { 'class': 'visible-hidden' }));
    }
    return elements;
  };
  return _react2.default.createElement(
